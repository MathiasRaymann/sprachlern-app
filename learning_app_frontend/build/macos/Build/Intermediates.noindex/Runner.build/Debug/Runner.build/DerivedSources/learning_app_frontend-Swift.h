...
#ifndef LEARNING_APP_FRONTEND_SWIFT_H
#define LEARNING_APP_FRONTEND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="learning_app_frontend",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC21learning_app_frontend11AppDelegate")
...
SWIFT_CLASS("_TtC21learning_app_frontend17MainFlutterWindow")
